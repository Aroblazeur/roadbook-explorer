  ...
  return (
    <StudioShell>
      ...
      {success && <p className="page-success">{success}</p>}
          ...
          <StartPointSection value={startPoint} onChange={setStartPoint} images={images} uploadLoading={uploadLoading} onUploadAccommodationPhoto={(file) => uploadMedia(file, { metadata: { purpose: "accommodation", accommodation_scope: "start-point" } })} />
