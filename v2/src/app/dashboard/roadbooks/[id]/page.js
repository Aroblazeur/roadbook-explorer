...
export default function RoadbookDetailPage() {
  ...
  const { images, setImages, uploadLoading, reloadMedia, uploadMedia } = useMediaManager({ supabase, roadbookId: id, userId: user?.id });
